import "./changeresearcherpassword.css";
...
const ChangeResearcherPassword = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (passwords.newPassword === passwords.confirmPassword) {
            const axiosPassConfig = {
                method: "put",
                url: `https://afrimentary.onrender.com/API/researcher/${id}/changepass`,
                data: passwords,
                headers: {
...
export default ChangeResearcherPassword;